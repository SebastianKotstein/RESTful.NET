...
{
    /// <summary>
    /// Represents an abstract filter component (see pipes-and-filter architectural pattern) which executes specific tasks similtanously with many but limited underlying threads. The execution of those tasks must be implemented in <see cref="Execute"/>.
    ...
    /// in <see cref="Init"/> and <see cref="Final"/>. The <see cref="LimitedMultiProcessor"/> has multiple underlying threads.
    /// </summary>
    public abstract class LimitedMultiProcessor : IDisposable
    {
