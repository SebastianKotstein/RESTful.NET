...
namespace SKotstein.Net.Http.Pipelining.Single
{
    ...
    /// In comparison to a <see cref="SingleFilter{I, O}"/>, the result of the executed task can be forwarded to a specific or even multiple outpute pipes depeding on the context of the task.
    /// The <see cref="SingleRouter{I, O}"/> is single-threaded, i.e. it has one underlying thread (see <see cref="SingleProcessor"/>).
    /// </summary>
    /// <typeparam name="I"></typeparam>
    /// <typeparam name="O"></typeparam>
    public abstract class SingleRouter<I,O> : SingleProcessor
    {
